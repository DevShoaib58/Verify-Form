            ...
            <div class=""><br>
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <table width="90%" border="1" align="center">
                        <tr>
                            <td colspan="2" class="thead" align="center">Verify your PSEC Certificate / Diploma</td>
                        </tr>

                        <tr>
                            <td colspan="2" class="text" style="height:40px;" align="center"><b>Please enter below
                                    your Roll Number to verify</b></td>
                        </tr>
